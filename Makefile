...
CFLAGS=-Os -DUSE_LUFA_CONFIG_HEADER -DARCH=ARCH_AVR8 -DBOARD=BOARD_NONE -DF_CPU=16000000UL -DF_USB=16000000UL -D__AVR_AT90USB1287__ -DHOST_DEVICE_SETTLE_DELAY_MS=2000 -mmcu=at90usb1287 -ISmallyMouse2/src/ -ISmallyMouse2/src/config/ -ISmallyMouse2/src/LUFA/
PORT=/dev/ttyACM0
...
# Install hex via DFU bootloader
dfu-install: smallymouse.hex
	dfu-programmer at90usb1287 erase --force
	dfu-programmer at90usb1287 flash smallymouse.hex

# Install hex via Atmel-ICE JTAG
ice-install: smallymouse.hex
